...
#ifndef MEDIAPIPE_TASKS_LIBMPTASK_COMPONENTS_CONTAINERS_KEYPOINT_H_
#define MEDIAPIPE_TASKS_LIBMPTASK_COMPONENTS_CONTAINERS_KEYPOINT_H_
...
#endif  // MEDIAPIPE_TASKS_LIBMPTASK_COMPONENTS_CONTAINERS_KEYPOINT_H_
