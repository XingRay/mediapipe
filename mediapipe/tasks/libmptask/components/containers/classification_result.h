...
#ifndef MEDIAPIPE_TASKS_LIBMPTASK_COMPONENTS_CONTAINERS_CLASSIFICATION_RESULT_H_
#define MEDIAPIPE_TASKS_LIBMPTASK_COMPONENTS_CONTAINERS_CLASSIFICATION_RESULT_H_
...
#endif  // MEDIAPIPE_TASKS_LIBMPTASK_COMPONENTS_CONTAINERS_CLASSIFICATION_RESULT_H_
