...
#ifndef MEDIAPIPE_TASKS_LIBMPTASK_VISION_CORE_IMAGE_PROCESSING_OPTIONS_H_
#define MEDIAPIPE_TASKS_LIBMPTASK_VISION_CORE_IMAGE_PROCESSING_OPTIONS_H_
...
#endif  // MEDIAPIPE_TASKS_LIBMPTASK_VISION_CORE_IMAGE_PROCESSING_OPTIONS_H_
